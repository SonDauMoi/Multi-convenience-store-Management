...
const PriceFilter = ({ onChange }) => {
  ...
  return (
    <div className="flex flex-col mb-4">
      <p className="text-base font-semibold text-black mb-4">Giá</p>
      <div className="px-2">
        <RangeSlider
      ...
      <div className="flex justify-between gap-3 mt-4">
        <div className="border border-gray-300 rounded h-10 flex-1 flex items-center">
          <p className="pl-3 text-gray-700 text-sm">₫</p>
          <input
            type="number"
            value={range?.min}
